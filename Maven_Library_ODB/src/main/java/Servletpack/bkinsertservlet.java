...
import connpackage.CrudBookBasee;
...
public class bkinsertservlet extends HttpServlet {
	...
	protected void service(HttpServletRequest request, HttpServletResponse response)
		...
		if (request.getParameter("givenisbn") == "" || request.getParameter("giventitle") == ""
			...
			int bkisbn = Integer.parseInt(request.getParameter("givenisbn"));
			String bkname = (String) request.getParameter("giventitle");
			String bkauthor = (String) request.getParameter("givenauthor");
			int bkprice = Integer.parseInt(request.getParameter("givenprice"));
			String bkcat = (String) request.getParameter("givencat");
			String result = crudbookbasee.insertnow(bkisbn, bkname, bkauthor, bkprice, bkcat);
			System.out.println(request.getParameter("givenisbn"));
